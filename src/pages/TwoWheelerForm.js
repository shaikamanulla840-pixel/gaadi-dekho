...
const TwoWheelerForm = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('/api/twoWheelers', formData, config);
    ...
    return (
        <div className="container mx-auto p-4">
            <h2 className="text-3xl font-bold text-center mb-8">Add New Two-Wheeler</h2>
            <form onSubmit={onSubmit} className="bg-white shadow-lg rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2 flex items-center">
                        <input type="checkbox" name="upcomingLaunch" checked={upcomingLaunch} onChange={(e) => setFormData({ ...formData, upcomingLaunch: e.target.checked })} className="mr-2" />
